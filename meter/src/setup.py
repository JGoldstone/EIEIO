...
# iPAExtension = Extension('i1ProAdapter', sources=['/Users/jgoldstone/Xcode/meterAdapter/i1ProAdapterModule.c'])
iPAExtension = Extension('i1ProAdapter', sources=['i1ProAdapterModule.c'])
