...
def print_meter_description(meter_desc):
    ...
    for measurement_mode in meter_desc.supported_measurement_modes:
        print_if_not_blank(MeasurementMode.Name(measurement_mode), 'supported spectral_measurement mode')
    print_if_not_blank(meter_desc.current_measurement_mode, 'current spectral_measurement mode')
    ...
    for measurement_angle in meter_desc.supported_measurement_angles:
        print_if_not_blank(measurement_angle, 'supported spectral_measurement angle')
    print_if_not_blank(meter_desc.current_measurement_angle, 'current spectral_measurement angle')
...
def pretty_print_colorimetry(spectral_measurement):
    color_space = ColorSpace.Name(spectral_measurement.color_space)
    illuminant = Illuminant.Name(spectral_measurement.illuminant)
