...
def write_medr_response(f):
    for (min_lambda, max_lambda) in [(380, 479), (480, 579), (580, 689), (680, 780)]:
        f.write(b'OK00')
...
class MyTestCase(unittest.TestCase):
    ...
    #         device = CS2000(meter_request_response_path=REQUEST_SINK, meter_response_override_path=temp_file)
    ...
    #         expected_sd = range(min_lambda, max_lambda + 1, inc_lambda)
